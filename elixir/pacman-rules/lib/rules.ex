defmodule Rules do
  ...
  def win?(has_eaten_all_dots?, power_pellet_active?, touching_ghost?) do
    ...
    not lose?(power_pellet_active?, touching_ghost?) and has_eaten_all_dots? and power_pellet_active? and touching_ghost? or has_eaten_all_dots? and not touching_ghost?
  end
end
